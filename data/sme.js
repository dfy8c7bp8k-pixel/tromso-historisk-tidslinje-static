/*
 * NORTHERN SÁMI TRANSLATION TEMPLATE
 *
 * This file intentionally contains the complete Norwegian source text.
 * A professional translator should replace the human-readable strings while
 * keeping ids, image paths, source URLs and object structure unchanged.
 * Keep the folder/data identifier as "sme". When the translation is finished,
 * set htmlLang to the BCP 47 tag "se", change <html lang> in sme/index.html
 * to "se", and remove translationNotice below.
 */
...
const page = {
  ...
  translationNotice:
    "Profesjonell nordsamisk oversettelse er ikke satt inn ennå. Siden viser foreløpig den norske kildeteksten.",
